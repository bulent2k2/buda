...
# NOTE: `test_bundle30_mp6b_seg7_span_is_tight` was removed here — its phantom-
# tail invariant is already covered for EVERY selected segment (bundle 30
# included) by test_no_phantom_abstract_span_beyond_detailed_extent above, and
# its hard-coded `bundle 30 / seg_idx 7` probe drifted as the planner's topology
# selection legitimately moved off that index. See
# docs/internal/mid_tier_failures_2026-07-29.md (§2).
