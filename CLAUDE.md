...
| `run_bundler <STRICT\|CONVERGENT\|BIDIRECTIONAL>` | 1 | Group nets into buses (CONVERGENT = fan-in by shared receiver; BIDIRECTIONAL = pair A→B with B→A. Both span multiple drivers → warn; see docs/internal/convergent_bundling.md) |
