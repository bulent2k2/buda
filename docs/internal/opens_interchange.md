...
2, 3, 4, 6 and 7 landed, and item 5's first blocker (the second `def.components`
walk) cleared — item 5 stays open on the remaining one. Each item states what is missing, why it was left rather than
